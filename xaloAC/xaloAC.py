...
while 1:
    ...
    print("""{}
       ...
       \ \/ / _` | |/ _ \ / /\ \| |     
        >  < (_| | | (_) / ____ \ |____ 
       /_/\_\__,_|_|\___/_/    \_\_____|  ig:@x410m1s0
                                     
                                  
    Sms: {}           {}by {}@xaloAC\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Gönder (Send SMS Normal)\n\n 2- SMS Gönder Hızlı (Send SMS TURBO)\n\n 3- Çıkış(exit)\n\n" + Fore.LIGHTYELLOW_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
    ...
    if menu == 1:
        ...
        if tel_no == "":
            ...
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Hatalı dosya . Düzeltip tekrar deneyiniz.")
                sleep(3)
                continue
        else:
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Yanlış telefon numarası. Tekrar deneyin.") 
                sleep(3)
                continue
        system("cls||clear")
        try:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Yanlış mail adresi. Tekrar deneyiniz.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
        ...
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Telefon numarasının başında '+90' olmadan yazınız: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Yanlış telefon numarası. Tekrar deneyiniz.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
